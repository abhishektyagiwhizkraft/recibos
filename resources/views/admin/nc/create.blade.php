...
<div class="row">
  <div class="col-md-12">
    <div class="card card-warning">
		...
		<form method="post" action="{{ route('admin.notacredit.store') }}" >
		@csrf
		<div class="card-body">
			<div class="row">
				<div class="col-md-4 font-weight-bold">CLIENTE : {{ $client->name }}</div>
				<div class="col-md-4 font-weight-bold">RTN : {{ $client->code }}</div>
				<div class="col-md-4">
					<div class="form-group pro_div {{ $errors->has('vendor') ? 'has-error' : '' }}">
						<label for="bank_name">Vendedor:</label>
						<select name="vendor_id" class="form-control ml-3">
			...
			<hr>
			<div class="create_form mb-4">
				<div class="form-group {{ $errors->has('products') ? 'has-error' : '' }}">
					<label for="products">Productos*</label>
					<div class="push_here pl-2 w-100">
					  <div class="each">
						<div class="row">
							<div class="col-md-7 mt-2">
							  <select name="products[1][id]" id="products" class="form-control sel_pro customselect2 ml-2" required=""> 
