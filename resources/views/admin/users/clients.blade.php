...
$(function () {
  ...
  $('.datatable-client').DataTable({
    ...
    ajax: {
          ...
          url: "{{ route('admin.salesClient',$id) }}",
    ...
    columns: [
        {
            ...
            {data: 'id',
               render: function(data){
                   ...
                   return '<a href="{{url('admin/clients/profile/')}}/'+data+'" class="btn btn-success mt-2"><i class="fas fa-user"></i> Profile</a> <a href="clients/'+data+'/delete" class="btn btn-danger mt-2 confirm"><i class="fas fa-trash"></i></a>';
                }
            },
