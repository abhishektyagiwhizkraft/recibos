...
$(function () {
  ...
  $('.datatable-products').DataTable({
    ...
    ajax: {
          ...
          url: "/admin/clients/"+user+"/orders?type="+type,
    ...
    columns: [
        {
            ...
            {data: 'id',
               render: function(id,type,data){
                   ...
                   var btns = '<a href="/admin/orders/'+id+'" class="btn btn-info mt-2" title="Mostrar"><i class="fa fa-eye"></i></a> <a href="/admin/orders/'+id+'/edit" class="btn btn-info mt-2" title="Editar"><i class="fa fa-edit"></i></a> <a href="/admin/orders/'+id+'/delete" class="btn btn-danger mt-2 confirm"><i class="fas fa-trash"></i></a>';
                   if(data.status == 1){

                      return btns + '@role('sales man') <a href="/admin/orders/deliver/'+id+'" class="btn btn-info mt-2">Envío</a>@endrole @role('sales person') <a href="/admin/orders/deliver/'+id+'" class="btn btn-info mt-2">Envío</a>@endrole';
                   }else{
