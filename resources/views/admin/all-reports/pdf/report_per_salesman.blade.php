...
<table style="margin:0 auto;border-spacing: 0;font-family: Helvetica Neue,sans-serif;" width="100%"  cellspacing="0">
	<tr>
		<td colspan="7" style="border-top: 2px solid #000;height: 20px;text-align: center;padding-top: 5px;padding-bottom: 10px;font-size: 16px;"><strong>Reporte Ventas x Vendedor</strong></td>
	</tr>
	<tr>
		<td colspan="7" style="padding-bottom: 4px;font-size: 12px;border-bottom: 1px solid #000;padding-left: 15px;">
	...
	<tr>
		...
		<td style="padding-bottom: 4px;font-size: 14px;border-bottom: 1px solid #000;padding-top: 4px;color: #891325;text-align: center;width: 11%;">
			<span><strong>Credito</strong></span>
		</td>
		<td style="padding-bottom: 4px;font-size: 14px;border-bottom: 1px solid #000;padding-left: 0;padding-top: 4px;color: #891325;text-align: center;width: 12%;">
	...
	<tr>
		<td style="font-size: 12px;padding-left: 15px;padding-bottom: 4px;width: 25%;padding-top: 4px;">
			<span>{{ $data['name'] }}</span>
		</td>
		<td style="padding-bottom: 4px;font-size: 12px;padding-left: 10px;padding-top: 4px;width: 10%;">
			<span></span>
		</td>
		<td style="padding-bottom: 4px;font-size: 12px;padding-top: 4px;width: 10%;text-align: right;">
			<span>{{ $data['contado'] }}</span>
		</td>
		<td style="padding-bottom: 4px;font-size: 12px;padding-top: 4px;text-align: right;width: 11%;">
			<span>{{ $data['credito'] }}</span>
		</td>
		<td style="padding-bottom: 4px;font-size: 12px;padding-left: 0;padding-top: 4px;text-align: right;width: 12%;">
			<span>{{ $data['subtotal'] }}</span>
		</td>
		<td style="padding-bottom: 4px;font-size: 12px;padding-left: 0;padding-top: 4px;text-align: right;width: 12%;">
			<span>{{ $data['isv'] }}</span>
		</td>
		<td style="padding-bottom: 4px;font-size: 12px;padding-left: 0;padding-top: 4px;text-align: right;width: 20%;padding-right: 15px;padding-left: 30px;">
	...
	<tr>
		...
		<td style="font-size: 14px;padding-left: 10px;padding-bottom: 4px;width: 10%;text-align: right;padding-right: 15px;">
			<span><strong>Totales:</strong></span>
		</td>
		<td style="font-size: 14px;padding-bottom: 4px;width: 10%;text-align: right;border-top: 1px solid #000;">
			<span><strong>{{ number_format($result['contado_total'], 2, '.', ',') }}</strong></span>
		</td>
		<td style="font-size: 14px;padding-bottom: 4px;text-align: right;width: 11%;border-top: 1px solid #000;">
			<span><strong>{{ number_format($result['credito_total'], 2, '.', ',') }}</strong></span>
		</td>
		<td style="font-size: 14px;padding-left: 0;padding-bottom: 4px;text-align: right;width: 12%;border-top: 1px solid #000;">
			<span><strong>{{ number_format($result['subtotal_total'], 2, '.', ',') }}</strong></span>
		</td>
		<td style="font-size: 14px;padding-left: 0;padding-bottom: 4px;text-align: right;width: 12%;border-top: 1px solid #000;">
			<span><strong>{{ number_format($result['isv_total'], 2, '.', ',') }}</strong></span>
		</td>
