...
class Order extends Model
{
	...
	protected $fillable = ['client','amount','tax','total','create_by','update_by','description'];

    public function products()
    {
        return $this->belongsToMany(Product::class)->withPivot(['id','initial_order_qty','qty','need']);
    }
